...
const MainPageTopBox = () => {
  ...
  const FilterBox = () => {
    return (
      <div className="absolute bg-white mt-[255px] w-[70%] h-[200px] rounded-lg shadow-[0px_4px_15px_rgba(0,0,0,0.2)] p-5 flex flex-col gap-3 overflow-scroll items-end z-[1]">
